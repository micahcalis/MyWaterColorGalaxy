...
namespace Beer::Rendering
{
    ...
    static const vk::Format SHALLOW_WATER_FORMAT = vk::Format::eR32Sfloat;
    ...
    static const uint32_t PAINT_INJECT_KERNEL = 0;
    static const uint32_t CALC_FLUX_KERNEL = 1;
    static const uint32_t PIGMENT_FLUX_KERNEL = 2;
    static const uint32_t FLUID_FLUX_KERNEL = 3;
    static const uint32_t TRANSFER_PGMNT_KERNEL = 4;
    static const uint32_t RENDER_PGMNT_KERNEL = 5;
    static const uint32_t EVAPORATE_KERNEL = 6;
    static const uint32_t CLEAR_LQDS_KERNEL = 7;

    class WaterColorSimBuffers
    {
    public:
        std::shared_ptr<Texture2D> CanvasBaseTexture = nullptr;
